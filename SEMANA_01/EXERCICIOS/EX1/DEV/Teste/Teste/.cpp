...
//
//int converteSensor(int value, int minRange, int maxRange) {
//	return int((float(value - minRange) / float(maxRange - minRange)) * 100);
//}
//
...
//	char answer;
//
//	printf("Deseja continuar com o mapeamento? Y/N");
//
//	cin >> answer;
//
//	if (toupper(answer) == 'N') {
...
//			posAtualVetor = InsertInArray(converteSensor(medida, 0, 830), posAtualVetor, vetorMov, maxVetor);
//		}
//
//		dirigindo = leComando();
//	}
